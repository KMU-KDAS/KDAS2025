...
> **Kalman Filter는 ‘노이즈 제거기’가 아니라, ‘정확한 모델을 전제로 하는 상태 추정기’다.**
...
모델과 노이즈 모두 부정확하자 Kalman Filter는 기대와 정반대의 결과를 냈다.
...
> “복잡한 필터가 항상 좋은 것은 아니다.  
> 실제 환경에서는 단순하지만 안정적인 처리가 더 강력할 때가 있다.”
